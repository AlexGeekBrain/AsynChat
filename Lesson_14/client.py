...
def arg_parser():
    ...
    return addr, port, client_name, client_passwd


if __name__ == '__main__':
    addr, port, client_name, client_passwd = arg_parser()
    ...
    logger.info(f'Запущен клиент с парамертами: адрес сервера: {addr} , порт: {port}, имя пользователя: {client_name}')
    ...
    main_window = ClientMainWindow(db, connect, keys)
